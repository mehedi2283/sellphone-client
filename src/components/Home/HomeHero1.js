...
const HomeHero1 = () => {
  ...
  <div class="absolute inset-x-0 top-[-10rem] -z-50 blur-2xl transform-gpu overflow-hidden  sm:top-[-20rem]">
    <svg class="relative left-[calc(50%-11rem)] -z-50 h-[21.1875rem] max-w-none -translate-x-1/2 rotate-[30deg] sm:left-[calc(50%-30rem)] sm:h-[42.375rem]" viewBox="0 0 1155 678" fill="none" xmlns="http://www.w3.org/2000/svg">
